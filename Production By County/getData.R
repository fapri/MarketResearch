...
if (type == "corn") {
  saveRDS(productionFinal, "Production By County/Raw_Producton_Corn.rds")
} else if (type == "soybeans") {
  saveRDS(productionFinal, "Production By County/Raw_Producton_Soybeans.rds")
}
...
# Save final lists
if (type == "corn") {
  saveRDS(production_List, "Production By County/Data/Production_List_Corn.rds")
} else if (type == "soybeans") {
  saveRDS(production_List, "Production By County/Data/Production_List_Soybeans.rds")
}
